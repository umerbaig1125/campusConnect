...
const LeaderHomeScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white px-4 pt-16">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="mt-6">
          <View className="flex-row justify-between items-center mb-8">
            ...
            <TouchableOpacity
              className="bg-[#ffe100] px-3 py-1 rounded-md"
              onPress={() => navigation.navigate('AddEventLeader')}
            >
              <Text className="text-black font-semibold text-sm">+ Create New Event</Text>
            </TouchableOpacity>
          </View>
