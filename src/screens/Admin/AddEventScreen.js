...
`;
    ...
    useEffect(() => {
        getStoredCredentials(); // Fetch credentials when component mounts
    }, []);
    ...
    const handleCreateEvent = async () => {
        if (!eventName || !eventVenue || !description || !image || !date || !time || !selectedSociety) {
        ...
        try {
            ...
            const payload = {
                ...
                createdBy: name,  // Include the user's name
    ...
    return (
        <View className="flex-1 bg-white px-4 pt-16">
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {/* Society Picker */}
                <View className="w-full border border-gray-300 h-12 px-4 bg-white rounded-lg mb-2 justify-center items-center">
                    <Picker
